...
/// @return font object
export function load_base64_font(data: string): AllegroFont {
...
/// @return font object
export function load_font(filename: string) {
  const s = document.createElement("style");
  _num_fonts += 1;
  const fontname = "font" + _num_fonts;
  s.id = fontname;
...
/// @return font object
export function create_font(family: string): AllegroFont {
